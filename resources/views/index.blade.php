<html lang="en-US" ng-app="employeeRecords">
  ...
  <button routerLink="gallery" class="btn btn-primary">Menu 1</button>
   <router-outlet></router-outlet>
        ...
        <div  ng-controller="employeesController" ng-init="getPosts">

            <!-- Table-to-load-the-data Part -->
            <div class="row">
                <div class="form-group">
                <div class="col-md-12">
                    <label for="inputEmail3" class="col-sm-3 control-label"><h3><b>Chercher:</b></h3></label>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr ng-repeat="employee in employees.data.data | filter:chercher">
